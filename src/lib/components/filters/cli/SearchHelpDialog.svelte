    ...
    >
            ...
            <table class="w-full border-collapse">
              ...
              <tbody class="divide-brdr divide-y">
                ...
                <tr>
                  ...
                  <td class="text-text-secondary px-4 py-2 text-sm">apyFrom&gt;5 apyTo&lt;20</td>
                </tr>
                <tr>
                  <td class="text-primary px-4 py-2 font-mono text-sm">{FilterKey.TVL_FROM}</td>
                  <td class="text-text-secondary px-4 py-2 text-sm">Total value locked</td>
                  <td class="text-text-secondary px-4 py-2 text-sm">tvlFrom&gt;1000000</td>
                </tr>
                <tr>
                  <td class="text-primary px-4 py-2 font-mono text-sm">{FilterKey.PROTOCOL_SLUG}</td>
      ...
      <footer class="border-brdr bg-bg-tertiary border-t px-6 py-4">
        <p class="text-text-tertiary text-sm">
          Pro tip: Use CMD+Enter or CTRL+Enter to execute the search.
        </p>
      </footer>
    </div>
  </div>
